...
//        let layout = UICollectionViewFlowLayout()
//        layout.scrollDirection = .vertical
//        let photosCollectionView = PhotosCollectionView(collectionViewLayout: layout)
//        self.addChild(photosCollectionView)
//        photosCollectionView.didMove(toParent: self)
//        photosCollectionView.view.frame = view.bounds
//        view.addSubview(photosCollectionView.view)
